...
class SizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create size' do
    assert_difference('Size.count') do
      post sizes_url, params: { size: { eu_name: @size.eu_name, fr_name: @size.fr_name, us_name: @size.us_name } }
    end
  ...
  test 'should update size' do
    patch size_url(@size), params: { size: { eu_name: @size.eu_name, fr_name: @size.fr_name, us_name: @size.us_name } }
