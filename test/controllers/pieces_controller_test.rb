...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference("Piece.count") do
      post pieces_url, params: { piece: { body_part_id: @piece.body_part_id, buy_link: @piece.buy_link, name: @piece.name, origin: @piece.origin, size_id: @piece.size_id, visibility: @piece.visibility } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { body_part_id: @piece.body_part_id, buy_link: @piece.buy_link, name: @piece.name, origin: @piece.origin, size_id: @piece.size_id, visibility: @piece.visibility } }
